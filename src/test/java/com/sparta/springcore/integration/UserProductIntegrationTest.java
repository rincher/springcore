...
class UserProductIntegrationTest {
    ...
    void test1(){
        ...
        // when
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {Product product = productService.createProduct(requestDto, userId);});
    ...
    void test5(){
        ...
        //lambda 형식으로 for each 문 대신 stream()을 이용해서 한개씩 출력가능
